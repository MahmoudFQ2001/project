        ...
        <div class="row">
            ...
            <div class="row">
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" name="mobile" id="mobile" placeholder="Enter Mobile Name of Admin">
                </div>
                <div class="form-group col-md-4">
                    <label for="email">Email</label>
                    <input type="email" class="form-control" name="email" id="email" placeholder="Enter Email Name of Admin">
                </div>
                <div class="form-group col-md-4">
            ...
            <div class="row">
                <div class="form-group col-md-4">
                    ...
                    <input type="date" class="form-control" name="date_of_birth" id="date_of_birth" placeholder="Enter Password Name of Admin">
                </div>
                <div class="form-group col-md-4">
